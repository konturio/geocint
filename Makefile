...
data/out/csv/view_count.csv: db/table/stat_h3 | data/out/csv ## extract view_count to csv file 
...
data/out/csv/count.csv: db/table/stat_h3 | data/out/csv ## extract count to csv file 
...
data/out/csv/highway_length.csv: db/table/stat_h3 | data/out/csv ## extract highway_length to csv file 
...
data/out/csv/total_road_length.csv: db/table/stat_h3 | data/out/csv ## extract total_road_length to csv file 
...
data/out/csv/local_hours.csv: db/table/stat_h3 | data/out/csv ## extract local_hours to csv file 
...
data/out/csv/total_hours.csv: db/table/stat_h3 | data/out/csv ## extract total_hours to csv file 
...
data/out/csv/avgmax_ts.csv: db/table/stat_h3 | data/out/csv ## extract avgmax_ts to csv file 
...
data/out/csv/days_mintemp_above_25c_1c.csv: db/table/stat_h3 | data/out/csv ## extract days_mintemp_above_25c_1c to csv file 
...
data/out/csv/building_count_6_months.csv: db/table/stat_h3 | data/out/csv ## extract building_count_6_months to csv file 
...
data/out/csv/highway_length_6_months.csv: db/table/stat_h3 | data/out/csv ## extract highway_length_6_months to csv file 
...
data/out/csv/osm_users.csv: db/table/stat_h3 | data/out/csv ## extract osm_users to csv file 
...
data/out/csv/residential.csv: db/table/stat_h3 | data/out/csv ## extract residential to csv file 
...
data/out/csv/gdp.csv: db/table/stat_h3 | data/out/csv ## extract gdp to csv file 
...
data/out/csv/min_ts.csv: db/table/stat_h3 | data/out/csv ## extract min_ts to csv file 
...
data/out/csv/max_ts.csv: db/table/stat_h3 | data/out/csv ## extract max_ts to csv file 
...
data/out/csv/wildfires.csv: db/table/stat_h3 | data/out/csv ## extract wildfires to csv file 
...
data/out/csv/volcanos_count.csv: db/table/stat_h3 | data/out/csv ## extract volcanos_count to csv file 
...
data/out/csv/pop_under_5_total.csv: db/table/stat_h3 | data/out/csv ## extract pop_under_5_total to csv file 
...
data/out/csv/pop_over_65_total.csv: db/table/stat_h3 | data/out/csv ## extract pop_over_65_total to csv file 
...
data/out/csv/poverty_families_total.csv: db/table/stat_h3 | data/out/csv ## extract poverty_families_total to csv file 
...
data/out/csv/pop_disability_total.csv: db/table/stat_h3 | data/out/csv ## extract pop_disability_total to csv file 
...
data/out/csv/pop_not_well_eng_speak.csv: db/table/stat_h3 | data/out/csv ## extract pop_not_well_eng_speak to csv file 
...
data/out/csv/pop_without_car.csv: db/table/stat_h3 | data/out/csv ## extract pop_without_car to csv file 
...
data/out/csv/foursquare_visits_count.csv: db/table/stat_h3 | data/out/csv ## extract foursquare_visits_count to csv file 
...
data/out/csv/eatery_count.csv: db/table/stat_h3 | data/out/csv ## extract eatery_count to csv file 
...
data/out/csv/food_shops_count.csv: db/table/stat_h3 | data/out/csv ## extract food_shops_count to csv file 
...
data/out/csv/waste_basket_coverage_area_km2.csv: db/table/stat_h3 | data/out/csv ## extract waste_basket_coverage_area_km2 to csv file 
	psql -q -X -c "copy (select h3, waste_basket_coverage_area_km2 from stat_h3 where h3 is not null and waste_basket_coverage_area_km2 is not null) to stdout with delimiter ',' csv;" > data/out/csv/waste_basket_coverage_area_km2.csv
	touch $@

data/out/csv/solar_farms_placement_suitability.csv: db/table/stat_h3 | data/out/csv ## extract solar_farms_placement_suitability to csv file 
...
data/out/csv/avg_elevation_gebco_2022.csv: db/table/stat_h3 | data/out/csv ## extract avg_elevation_gebco_2022 to csv file 
...
data/out/csv/shrubs.csv: db/table/stat_h3 | data/out/csv ## extract shrubs to csv file 
...
data/out/csv/herbage.csv: db/table/stat_h3 | data/out/csv ## extract herbage to csv file 
...
data/out/csv/unknown_forest.csv: db/table/stat_h3 | data/out/csv ## extract unknown_forest to csv file 
...
data/out/csv/avg_ndvi.csv: db/table/stat_h3 | data/out/csv ## extract avg_ndvi to csv file 
...
data/out/csv/days_maxtemp_over_32c_1c.csv: db/table/stat_h3 | data/out/csv ## extract days_maxtemp_over_32c_1c to csv file 
...
data/out/csv/days_maxtemp_over_32c_2c.csv: db/table/stat_h3 | data/out/csv ## extract days_maxtemp_over_32c_2c to csv file 
...
data/out/csv/days_mintemp_above_25c_2c.csv: db/table/stat_h3 | data/out/csv ## extract days_mintemp_above_25c_2c to csv file 
...
data/out/csv/days_maxwetbulb_over_32c_1c.csv: db/table/stat_h3 | data/out/csv ## extract days_maxwetbulb_over_32c_1c to csv file 
...
data/out/csv/days_maxwetbulb_over_32c_2c.csv: db/table/stat_h3 | data/out/csv ## extract days_maxwetbulb_over_32c_2c to csv file 
...
data/out/csv/mandays_maxtemp_over_32c_1c.csv: db/table/stat_h3 | data/out/csv ## extract mandays_maxtemp_over_32c_1c to csv file 
...
data/out/csv/mhr_index.csv: db/table/stat_h3 | data/out/csv ## extract mhr_index to csv file 
...
data/out/csv/mhe_index.csv: db/table/stat_h3 | data/out/csv ## extract mhe_index to csv file 
...
data/out/csv/resilience_index.csv: db/table/stat_h3 | data/out/csv ## extract resilience_index to csv file 
...
data/out/csv/coping_capacity_index.csv: db/table/stat_h3 | data/out/csv ## extract coping_capacity_index to csv file 
...
data/out/csv/vulnerability_index.csv: db/table/stat_h3 | data/out/csv ## extract vulnerability_index to csv file 
...
data/out/csv/hazardous_days_count.csv: db/table/stat_h3 | data/out/csv ## extract hazardous_days_count to csv file 
...
data/out/csv/earthquake_days_count.csv: db/table/stat_h3 | data/out/csv ## extract earthquake_days_count to csv file 
...
data/out/csv/wildfire_days_count.csv: db/table/stat_h3 | data/out/csv ## extract wildfire_days_count to csv file 
...
data/out/csv/drought_days_count.csv: db/table/stat_h3 | data/out/csv ## extract drought_days_count to csv file 
...
data/out/csv/cyclone_days_count.csv: db/table/stat_h3 | data/out/csv ## extract cyclone_days_count to csv file 
...
data/out/csv/volcano_days_count.csv: db/table/stat_h3 | data/out/csv ## extract volcano_days_count to csv file 
...
data/out/csv/flood_days_count.csv: db/table/stat_h3 | data/out/csv ## extract flood_days_count to csv file 
...
data/out/csv/powerlines.csv: db/table/stat_h3 | data/out/csv ## extract powerlines to csv file 
...
data/out/csv/worldclim_avg_temperature.csv: db/table/stat_h3 | data/out/csv ## extract worldclim_avg_temperature to csv file 
...
data/out/csv/worldclim_min_temperature.csv: db/table/stat_h3 | data/out/csv ## extract worldclim_min_temperature to csv file 
...
data/out/csv/worldclim_max_temperature.csv: db/table/stat_h3 | data/out/csv ## extract worldclim_max_temperature to csv file 
...
data/out/csv/worldclim_amp_temperature.csv: db/table/stat_h3 | data/out/csv ## extract worldclim_amp_temperature to csv file 
...
data/out/csv/powerlines_proximity_m.csv: db/table/stat_h3 | data/out/csv ## extract powerlines_proximity_m to csv file 
...
data/out/csv/populated_areas_proximity_m.csv: db/table/stat_h3 | data/out/csv ## extract populated_areas_proximity_m to csv file 
...
data/out/csv/power_substations_proximity_m.csv: db/table/stat_h3 | data/out/csv ## extract power_substations_proximity_m to csv file 
...
data/out/csv/solar_power_plants.csv: db/table/stat_h3 | data/out/csv ## extract solar_power_plants to csv file 
...
data/out/csv/safety_index.csv: db/table/stat_h3 | data/out/csv ## extract safety_index to csv file 
...
deploy/dev/uploads/count_upload: data/out/csv/count.csv | data/out/csv ## upload count to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/count.csv "count" "OSM: objects count" "[[\"bad\"], [\"good\"]]" false true "[\"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\"]" "Total number of objects in a given area according to OpenStreetMap." "World" "daily" "n" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/man_distance_to_fire_brigade_upload: data/out/csv/man_distance_to_fire_brigade.csv | data/out/csv ## upload man_distance_to_fire_brigade to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/man_distance_to_fire_brigade.csv "man_distance_to_fire_brigade" "Man-distance to fire brigade" "[[\"good\"], [\"bad\"]]" false false "[\"© Kontur https://kontur.io/\", \"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\"]" "" "World" "daily" "other" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/evergreen_needle_leaved_forest_upload: data/out/csv/evergreen_needle_leaved_forest.csv | data/out/csv ## upload evergreen_needle_leaved_forest to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/evergreen_needle_leaved_forest.csv "evergreen_needle_leaved_forest" "Landcover: evergreen needleleaf forest" "[[\"unimportant\"], [\"important\"]]" false true "[\"© Kontur https://kontur.io/\", \"Copernicus Global Land Service: Land Cover 100 m: Marcel Buchhorn, Bruno Smets, Luc Bertels, Bert De Roo, MyroslavaLesiv, Nandin - Erdene Tsendbazar, … Steffen Fritz. (2020). Copernicus Global Land Service: Land Cover 100m: collection 3: epoch 2019: Globe (Version V3.0.1) Data set. Zenodo. http://doi.org/10.5281/zenodo.3939050\"]" "Area covered by either closed or open evergreen needleleaf forest. Almost all needleleaf trees remain green all year. Canopy is never without green foliage. Closed forest has tree canopy >70%. Open forest has top layer - trees 15-70 % - and second layer - mix of shrubs and grassland." "World" "static" "km2" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@

deploy/dev/uploads/shrubs_upload: data/out/csv/shrubs.csv | data/out/csv ## upload shrubs to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/shrubs.csv "shrubs" "Landcover: shrubland" "[[\"unimportant\"], [\"important\"]]" false true "[\"© Kontur https://kontur.io/\", \"Copernicus Global Land Service: Land Cover 100 m: Marcel Buchhorn, Bruno Smets, Luc Bertels, Bert De Roo, MyroslavaLesiv, Nandin - Erdene Tsendbazar, … Steffen Fritz. (2020). Copernicus Global Land Service: Land Cover 100m: collection 3: epoch 2019: Globe (Version V3.0.1) Data set. Zenodo. http://doi.org/10.5281/zenodo.3939050\"]" "Shrubland, or area where vegetation is dominated by woody perennial plants generally less than 5 meters in height, with persistent and woody stems and without any defined main stem. The shrub foliage can be either evergreen or deciduous." "World" "static" "km2" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@

deploy/dev/uploads/herbage_upload: data/out/csv/herbage.csv | data/out/csv ## upload herbage to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/herbage.csv "herbage" "Landcover: herbaceous vegetation" "[[\"unimportant\"], [\"important\"]]" false true "[\"© Kontur https://kontur.io/\", \"Copernicus Global Land Service: Land Cover 100 m: Marcel Buchhorn, Bruno Smets, Luc Bertels, Bert De Roo, MyroslavaLesiv, Nandin - Erdene Tsendbazar, … Steffen Fritz. (2020). Copernicus Global Land Service: Land Cover 100m: collection 3: epoch 2019: Globe (Version V3.0.1) Data set. Zenodo. http://doi.org/10.5281/zenodo.3939050\"]" "Area covered by herbaceous plants. These plants have no persistent woody stems above ground and lack definite firm structure. Tree and shrub cover is less than 10%." "World" "static" "km2" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/avg_slope_gebco_2022_upload: data/out/csv/avg_slope_gebco_2022.csv | data/out/csv ## upload avg_slope_gebco_2022 to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/avg_slope_gebco_2022.csv "avg_slope_gebco_2022" "Slope (avg)" "[[\"good\", \"unimportant\"], [\"bad\", \"important\"]]" false true "[\"© Data from General Bathymatric Chart of the Oceans, www.gebco.net\"]" "Average surface slope." "World" "static" "deg" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/volcanos_count_upload: data/out/csv/volcanos_count.csv | data/out/csv ## upload volcanos_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/volcanos_count.csv "volcanos_count" "OSM: volcanoes count" "[[\"unimportant\"], [\"important\"]]" false true "[\"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\"]" "Number of volcanoes in a given area." "World" "daily" "n" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/foursquare_places_count_upload: data/out/csv/foursquare_places_count.csv | data/out/csv ## upload foursquare_places_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/foursquare_places_count.csv "foursquare_places_count" "Foursquare Japan places count" "[[\"unimportant\"], [\"important\"]]" false false "[\"©Foursquare Labs Inc\", \"Sample data\"]" "" "Japan" "static" "n" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/foursquare_visits_count_upload: data/out/csv/foursquare_visits_count.csv | data/out/csv ## upload foursquare_visits_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/foursquare_visits_count.csv "foursquare_visits_count" "Foursquare Japan visits count" "[[\"unimportant\"], [\"important\"]]" false false "[\"©Foursquare Labs Inc\", \"Sample data\"]" "" "Japan" "static" "n" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/man_distance_to_hospital_upload: data/out/csv/man_distance_to_hospital.csv | data/out/csv ## upload man_distance_to_hospital to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/man_distance_to_hospital.csv "man_distance_to_hospital" "Man-distance to hospitals" "[[\"good\"], [\"bad\"]]" false false "[\"© Kontur https://kontur.io/\", \"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\"]" "" "World" "daily" "other" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/man_distance_to_bomb_shelters_upload: data/out/csv/man_distance_to_bomb_shelters.csv | data/out/csv ## upload man_distance_to_bomb_shelters to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/man_distance_to_bomb_shelters.csv "man_distance_to_bomb_shelters" "Man-distance to bomb shelters" "[[\"good\"], [\"bad\"]]" false false "[\"© Kontur https://kontur.io/\", \"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\"]" "" "World" "daily" "other" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/man_distance_to_charging_stations_upload: data/out/csv/man_distance_to_charging_stations.csv | data/out/csv ## upload man_distance_to_charging_stations to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/man_distance_to_charging_stations.csv "man_distance_to_charging_stations" "Man-distance to charging stations" "[[\"good\"], [\"bad\"]]" false false "[\"© Kontur https://kontur.io/\", \"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\"]" "" "World" "daily" "other" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/total_road_length_upload: data/out/csv/total_road_length.csv | data/out/csv ## upload total_road_length to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/total_road_length.csv "total_road_length" "Total road length" "[[\"unimportant\"], [\"important\"]]" false true "[\"©2019 Facebook, Inc. and its affiliates https://github.com/facebookmicrosites/Open-Mapping-At-Facebook/blob/main/LICENSE.md\", \"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\", \"© Kontur https://kontur.io/\"]" "Estimated total road length according to Meta (Facebook) AI and OpenStreetMap data. For places where Meta (Facebook) roads data are unavailable, the estimation is based on statistical regression from Kontur Population data." "World" "daily" "km" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/coping_capacity_index_upload: data/out/csv/coping_capacity_index.csv | data/out/csv ## upload coping_capacity_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/coping_capacity_index.csv "coping_capacity_index" "PDC GRVA Coping сapacity" "[[\"important\", \"bad\"], [\"good\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/resilience_index_upload: data/out/csv/resilience_index.csv | data/out/csv ## upload resilience_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/resilience_index.csv "resilience_index" "PDC GRVA Resilience" "[[\"important\", \"bad\"], [\"good\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/vulnerability_index_upload: data/out/csv/vulnerability_index.csv | data/out/csv ## upload vulnerability_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/vulnerability_index.csv "vulnerability_index" "PDC GRVA Vulnerability" "[[\"unimportant\"], [\"important\", \"bad\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/mapswipe_area_km2_upload: data/out/csv/mapswipe_area_km2.csv | data/out/csv ## upload mapswipe_area_km2 to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/mapswipe_area_km2.csv "mapswipe_area_km2" "Human activity" "[[\"unimportant\"], [\"important\"]]" false true "[\"Copyright © 2022 MapSwipe https://mapswipe.org/en/privacy.html\"]" "Places were MapSwipe users have detected some human activity through features (i.e. buildings, roadways, waterways, etc.) on satellite images." "World" "daily" "km2" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@

deploy/dev/uploads/gsa_ghi_upload: data/out/csv/gsa_ghi.csv | data/out/csv ## upload gsa_ghi to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/gsa_ghi.csv "gsa_ghi" "Global Horizontal Irradiance (GHI)" "[[\"bad\", \"unimportant\"], [\"good\", \"important\"]]" false true "[\"Copyright © 2022 The World Bank https://globalsolaratlas.info/support/terms-of-use\"]" "Total amount of shortwave terrestrial irradiance received by a surface horizontal to the ground." "World (-60:60 latitudes)" "static" "W_m2" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/powerlines_proximity_m_upload: data/out/csv/powerlines_proximity_m.csv | data/out/csv ## upload powerlines_proximity_m to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/powerlines_proximity_m.csv "powerlines_proximity_m" "Proximity to: powerlines grid" "[[\"important\"], [\"unimportant\"]]" false true "[\"Copyright © OpenStreetMap contributors https://www.openstreetmap.org/copyright\", \"© 2020 The World Bank Group, CC-BY 4.0\"]" "Distance to closest powerline" "World" "static" "m" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/power_substations_proximity_m_upload: data/out/csv/power_substations_proximity_m.csv | data/out/csv ## upload power_substations_proximity_m to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/power_substations_proximity_m.csv "power_substations_proximity_m" "Proximity to power substations, m" "[[\"good\"], [\"bad\"]]" false true "[\"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\"]" "Distance to closest power substation" "World" "daily" "m" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@

deploy/dev/uploads/area_km2_upload: data/out/csv/area_km2.csv | data/out/csv ## upload area_km2 to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/area_km2.csv "area_km2" "Area" "[[\"neutral\"], [\"neutral\"]]" true false "[\"Concept of areas © Brahmagupta, René Descartes\"]" "" "World" "static" "km2" "$(date -r db/table/osm +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
