...
data/out/csv/osm_car_parkings_count.csv: db/table/osm_transport_facilities_h3 | data/out/csv ## extract osm_car_parkings_count to csv file
	psql -q -X -c "copy (select h3, osm_car_parkings_count from osm_transport_facilities_h3 where h3 is not null and osm_car_parkings_count is not null and osm_car_parkings_count > 0 order by h3) to stdout with delimiter ',' csv;" > $@
...
deploy_indicators/dev/uploads/osm_car_parkings_count_upload: data/out/csv/osm_car_parkings_count.csv | deploy_indicators/dev/uploads ## upload osm_car_parkings_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/osm_car_parkings_count.csv "osm_car_parkings_count" db/table/osm_transport_facilities_h3
	touch $@
...
deploy_indicators/test/uploads/osm_car_parkings_count_upload: data/out/csv/osm_car_parkings_count.csv | deploy_indicators/test/uploads ## upload osm_car_parkings_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/osm_car_parkings_count.csv "osm_car_parkings_count" db/table/osm_transport_facilities_h3
	touch $@
...
deploy_indicators/prod/uploads/osm_car_parkings_count_upload: data/out/csv/osm_car_parkings_count.csv | deploy_indicators/prod/uploads ## upload osm_car_parkings_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh prod data/out/csv/osm_car_parkings_count.csv "osm_car_parkings_count" db/table/osm_transport_facilities_h3
	touch $@
