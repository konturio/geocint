...
insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('raw_mhe_pop_scaled', 'raw_mhe_pop_scaled', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('raw_mhe_cap_scaled', 'raw_mhe_cap_scaled', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('raw_mhe_index', 'raw_mhe_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('relative_mhe_pop_scaled', 'relative_mhe_pop_scaled', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('relative_mhe_cap_scaled', 'relative_mhe_cap_scaled', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('relative_mhe_index', 'relative_mhe_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);
...
insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('life_expectancy_scale', 'life_expectancy_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('infant_mortality_scale', 'infant_mortality_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('maternal_mortality_scale', 'maternal_mortality_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('prevalence_undernourished_scale', 'prevalence_undernourished_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('vulnerable_health_status_index', 'vulnerable_health_status_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('pop_wout_improved_sanitation_scale', 'pop_wout_improved_sanitation_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('pop_wout_improved_water_scale', 'pop_wout_improved_water_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('clean_water_access_vulnerability_index', 'clean_water_access_vulnerability_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('adult_illiteracy_scale', 'adult_illiteracy_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('gross_enrollment_scale', 'gross_enrollment_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('years_of_schooling_scale', 'years_of_schooling_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('pop_wout_internet_scale', 'pop_wout_internet_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('info_access_vulnerability_index', 'info_access_vulnerability_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('export_minus_import_percent_scale', 'export_minus_import_percent_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('average_inflation_scale', 'average_inflation_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('economic_dependency_scale', 'economic_dependency_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('economic_constraints_index', 'economic_constraints_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('female_govt_seats_scale', 'female_govt_seats_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('female_male_secondary_enrollment_scale', 'female_male_secondary_enrollment_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('female_male_labor_ratio_scale', 'female_male_labor_ratio_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('gender_inequality_index', 'gender_inequality_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('max_political_discrimination_scale', 'max_political_discrimination_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('max_economic_discrimination_scale', 'max_economic_discrimination_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('ethnic_discrimination_index', 'ethnic_discrimination_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('marginalization_index', 'marginalization_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('population_change_scale', 'population_change_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('urban_population_change_scale', 'urban_population_change_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('population_pressures_index', 'population_pressures_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('freshwater_withdrawals_scale', 'freshwater_withdrawals_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('forest_area_change_scale', 'forest_area_change_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('ruminant_density_scale', 'ruminant_density_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('environmental_stress_index', 'environmental_stress_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('recent_disaster_losses_scale', 'recent_disaster_losses_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('recent_disaster_deaths_scale', 'recent_disaster_deaths_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('recent_disaster_impacts_index', 'recent_disaster_impacts_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('recent_conflict_deaths_scale', 'recent_conflict_deaths_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('displaced_populations_scale', 'displaced_populations_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('conflict_impacts_index', 'conflict_impacts_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);
...
insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('voice_and_accountability_scale', 'voice_and_accountability_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('rule_of_law_scale', 'rule_of_law_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('political_stability_scale', 'political_stability_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('govt_effectiveness_scale', 'govt_effectiveness_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('control_of_corruption_scale', 'control_of_corruption_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('governance_index', 'governance_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('gni_per_capita_scale', 'gni_per_capita_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('reserves_per_capita_scale', 'reserves_per_capita_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('economic_capacity_index', 'economic_capacity_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('fixed_phone_access_scale', 'fixed_phone_access_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('mobile_phone_access_scale', 'mobile_phone_access_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('internet_server_access_scale', 'internet_server_access_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('communications_capacity_index', 'communications_capacity_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('port_rnwy_density_scale', 'port_rnwy_density_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('road_rr_density_scale', 'road_rr_density_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('transportation_index', 'transportation_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('hospital_bed_density_scale', 'hospital_bed_density_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('nurses_midwives_scale', 'nurses_midwives_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('physicians_scale', 'physicians_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('health_care_capacity_index', 'health_care_capacity_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('infrastructure_capacity_index', 'infrastructure_capacity_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('biome_protection_scale', 'biome_protection_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('marine_protected_area_scale', 'marine_protected_area_scale', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);

insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('environmental_capacity_index', 'environmental_capacity_index', jsonb_build_array(
        '© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/'),
        '[["good"], ["bad"]]'::jsonb);
