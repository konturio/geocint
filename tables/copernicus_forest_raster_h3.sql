...
drop table if exists copernicus_forest_raster_h3;
create table copernicus_forest_raster_h3 as (
    select h3,
           8    as resolution,
           true as has_forest
    from (
...
alter table copernicus_forest_raster_h3
    add column forest_cells float;

update copernicus_forest_raster_h3
set forest_cells = 1;
...
$$
    ...
    begin
        ...
        while res > 0
            loop
                insert into copernicus_forest_raster_h3 (h3, forest_cells, resolution)
