                           ...
                           'correlationRates', (
                               select
                                   jsonb_agg(jsonb_build_object(
                                                 'x', jsonb_build_object('label', param_label,
                                                                         'quotient',
                                                                         jsonb_build_array(x_num, x_den)),
                                                 'y', jsonb_build_object('label', param_label,
                                                                         'quotient',
                               ...
                               from
                                   bivariate_axis_correlation, bivariate_copyrights
                               where param_id = x_num and param_id = y_num
                           ),
                           'initAxis',
