...
\nNote: To use links in the Name field and open the exact area you want to edit, please install [JOSM](https://josm.openstreetmap.de/) and run with enabled [remote control](https://wiki.openstreetmap.org/wiki/JOSM/RemoteControl), an open-source editor for OpenStreetMap.',
        true,
        '{1}',
        true
from osm_meta;
...
\nNote: To use links in the OSM Name field and open the exact area you want to edit, please install [JOSM](https://josm.openstreetmap.de/) and run with enabled [remote control](https://wiki.openstreetmap.org/wiki/JOSM/RemoteControl), an open-source editor for OpenStreetMap.',
        false,
        '{2}',
        true
from osm_meta;
...
\nNote: To open the area you want to edit, please install [JOSM](https://josm.openstreetmap.de/) and run with enabled [remote control](https://wiki.openstreetmap.org/wiki/JOSM/RemoteControl), an open-source editor for OpenStreetMap.',
        false,
        '{1}',
        true
from osm_meta;
