...
python3 -m hdxloader update -t country-boundaries --update_by_iso3 --iso3_file hdxloader/config/update-country-boundaries-customviz.yml --hdx-site prod -k $API_TOKEN --no-dry-run