...
db/table/osm_water_polygons: db/table/osm_water_polygons_subdivided db/table/water_polygons_vector db/table/osm_water_lines_buffers_subdivided | db/table
	psql -f tables/osm_water_polygons.sql
	touch $@
