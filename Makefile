...
data/mid/worldclim/avg_temp/average_temperatures.tif: data/mid/worldclim/avg_temp/unzip | data/mid/worldclim/avg_temp ## Change resolution of average yearly temperature from Worldclim montly means
	rm -f $@
...
data/mid/worldclim/max_temp/maximal_temperatures.tif: data/mid/worldclim/max_temp/unzip | data/mid/worldclim/max_temp ## Change resolution of maximal yearly temperature from Worldclim montly maximals
	rm -f $@
	gdalwarp data/mid/worldclim/max_temp/maximal_temperatures_in.tif -co compress=deflate -tr 0.005 0.005 $@
	rm -f data/mid/worldclim/max_temp/maximal_temperatures_in.tif
