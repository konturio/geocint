...
db/table/wikidata_naturalization_gap_h3: db/table/wikidata_naturalization_gap | db/procedure/generate_overviews db/procedure/transform_hasc_to_h3 db/table/kontur_boundaries_v4 ## Generation overviws of wikidata years_to_naturalisation and multiple_citizenship
...
db/table/worldbank_tax_rate_h3: db/table/worldbank_tax_rate | db/table/kontur_boundaries_v4 db/procedure/generate_overviews db/procedure/transform_hasc_to_h3 ## Generation overviws of worldbank_tax_rate
...
db/table/idmc_country_2023_h3: db/table/idmc_country_2023 | db/procedure/generate_overviews db/procedure/transform_hasc_to_h3_percent_of_population db/table/kontur_boundaries_v4 ## Create idmc_country_2023_h3 and genarate overviews
...
db/table/worldbank_inflation_h3: db/table/worldbank_inflation | db/table/kontur_boundaries_v4 db/procedure/generate_overviews db/procedure/transform_hasc_to_h3 ## Generation overviws of worldbank_inflation
...
db/table/global_rva_h3: db/table/global_rva_indexes | db/table/kontur_boundaries_v4 db/procedure/generate_overviews db/procedure/transform_hasc_to_h3 db/table ## Generation overviws of global rva indexes
...
db/table/ndpba_rva_h3: db/table/ndpba_rva_indexes | db/table/kontur_boundaries_v4 db/procedure/generate_overviews db/procedure/transform_hasc_to_h3 db/table ## Generation overviews of ndpba rva indexes
...
db/table/inform_risk_profile_2025_h3: db/table/inform_risk_profile_2025 | db/procedure/generate_overviews db/procedure/transform_hasc_to_h3 db/table/kontur_boundaries_v4 ## Generation overviews of Human Development Index (HDI)
