...
create table stat_h3_in as (
    select h3,
           ...
           coalesce(sum(osm_building_count), 0) as osm_building_count,
           ...
           1::float as one
    from (
             select h3, count as count, building_count as osm_building_count, null::float as building_count, highway_length as highway_length,
             ...
             union all
             select h3, null::float as count, null::float as osm_building_count, null::float as building_count, null::float as highway_length,
             ...
             from tile_logs_h3
             union all
             select h3, null::float as count, null::float as osm_building_count, building_count as building_count, null::float as highway_length,
                    null::float as osm_users, null::float as population, null::float as residential, null::float as gdp,
                    null::float as avg_ts, null::float as max_ts, null::float as p90_ts, null::float as local_hours,
                    null::float as total_hours, view_count::float as view_count, null::float as wildfires, resolution
