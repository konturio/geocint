...
$$
    ...
    begin
        ...
        drop table if exists poverty_rates_h3;

        -- create final table
        create table poverty_rates_h3 (h3 h3index, poverty_rate integer, resolution integer);

        carry = 0;
        for cur_row in (select * from poverty_rates_h3_mid order by h3)
            loop
                ...
                if cur_value >= 0
                then
                    insert into poverty_rates_h3 (h3, poverty_rate, resolution)
