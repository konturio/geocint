...
values ('population_tag_check',
        ...
        'https://geocint.kontur.io/gis/population_check_osm.csv',
        '',
...
values ('osm_population_inconsistencies',
        ...
        'https://geocint.kontur.io/gis/osm_population_inconsistencies.csv',
        '',
...
values ('osm_gadm_comparison',
        'OSM-GADM comparison',
        'https://geocint.kontur.io/gis/osm_gadm_comparison.csv',
        '',
