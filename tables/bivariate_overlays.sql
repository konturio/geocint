...
select 12,
       ...
       json_extract_path_text(meta::json, 'data', 'timestamp', 'last') || E' \n\n',
       '[{"id":"A1","color":"rgb(232,232,157)"},
         {"id":"A2","color":"rgb(186,226,153)"},{"id":"B1","color":"rgb(186,226,153)"},
         {"id":"A3","color":"rgb(90,200,127)"},{"id":"B2","color":"rgb(90,200,127)"},{"id":"C1","color":"rgb(90,200,127)"},
         {"id":"B3","color":"rgb(112,186,128)"},{"id":"C2","color":"rgb(112,186,128)"},
         {"id":"C3","color":"rgb(83,152,10)"}]',
       true
from osm_meta;
