...
insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('view_count', 'Map views', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('avg_ts', 'Average time stamp', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('max_ts', 'Max time stamp', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('p90_ts', '90% time stamp', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('osm_users', 'OSM users', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('building_count', 'OSM buildings', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('highway_length', 'Highway length', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('local_hours', 'Edits by local mappers', jsonb_build_array('© Kontur https://kontur.io/',
'© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('total_hours', 'Edits by all mappers', jsonb_build_array('© Kontur https://kontur.io/',
'© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('gdp', 'GDP', jsonb_build_array(
...
insert into bivariate_copyrights (param_id, param_label, copyrights)
values ('wildfires', 'Wildfires', jsonb_build_array(
