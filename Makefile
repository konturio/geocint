...
data/out/isochrone_destinations_export: db/table/isodist_fire_stations_h3 db/table/isodist_hospitals_h3 | data/out ## Temporary export target for isochrone destinations.
	touch $@
