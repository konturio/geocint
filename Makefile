...
data/planet-is-broken: data/planet-latest-updated.osm.pbf | data
	osmium check-refs -r --no-progress data/planet-latest.osm.pbf ; if [ $$? -eq 1 ] ; then touch $@ ; fi
