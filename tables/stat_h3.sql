...
create table stat_h3_in as (
    select h3,
		   ...
		   coalesce(sum(vaccine_value), 0) as vaccine_value,
		   coalesce(sum(cases_value), 0) as cases_value,
           1::float as one
    from (
             select h3, count as count, count_6_months as count_6_months, building_count as building_count,
                    ...
                    null::float as wildfires, null::float as vaccine_value, null::float as cases_value, resolution
             ...
             select h3, null::float as count, null::float as count_6_months, null::float as building_count,
                    ...
                    null::float as wildfires, null::float as vaccine_value, null::float as cases_value, h3_get_resolution(h3) as resolution
             from user_hours_h3
             union all
             select h3, null::float as count, null::float as count_6_months, null::float as building_count,
                    null::float as building_count_6_months, null::float as total_building_count, null::float as highway_length,
             ...
             select h3, null::float as count, null::float as count_6_months, null::float as building_count,
                    ...
                    null::float as residential, null::float as gdp, null::float as avg_ts, null::float as max_ts,
                    null::float as p90_ts, null::float as local_hours, null::float as total_hours, null::float as view_count,
                    wildfires as wildfires, null::float as vaccine_value, null::float as cases_value, resolution
             ...
             select h3, null::float as count, null::float as count_6_months, null::float as building_count,
                    ...
                    null::float as residential, null::float as gdp, null::float as avg_ts, null::float as max_ts,
                    null::float as p90_ts, null::float as local_hours, null::float as total_hours, null::float as view_count,
                    null::float as wildfires, vaccine_value as vaccine_value, null::float as cases_value, resolution
             ...
             select h3, null::float as count, null::float as count_6_months, null::float as building_count,
                    ...
                    null::float as residential, null::float as gdp, null::float as avg_ts, null::float as max_ts,
                    null::float as p90_ts, null::float as local_hours, null::float as total_hours, null::float as view_count,
                    null::float as wildfires, null::float as vaccine_value, cases_value as cases_value, resolution
