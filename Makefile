...
db/table/solar_farms_placement_suitability_synthetic_h3: db/table/proximities_h3 db/table/worldclim_temperatures_h3 db/table/global_solar_atlas_h3 db/table/gebco_2022_h3 db/procedure/generate_overviews db/table/kontur_population_h3 | db/table ## create a table with synthetic solar farms placement suitability (MCDA)
