...
select 'osm_gadm_comparison',
        ...
        E'Compare [GADM](https://gadm.org/data.html) and OpenStreetMap statistics on administrative division to find potential gaps in OpenStreetMap data. GADM boundary data is a global dataset with an administrative division of all countries. Its [license](https://gadm.org/license.html) forbids importing it into OpenStreetMap, but this report by [Kontur](https://www.kontur.io/) allows you to analyze the hierarchy of boundaries in GADM and OpenStreetMap. The last column shows the number of subregions for every admin boundary found in GADM/OSM to make potential conclusions. GADM is not the [''ground truth''](https://wiki.openstreetmap.org/wiki/Ground_truth), but a big difference in stats is a good reason to look carefully into OpenStreetMap data. Click here to download this report as a csv-file: [https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_reports@@@@@/osm_gadm_comparison.csv](https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_reports@@@@@/osm_gadm_comparison.csv) \n&nbsp;
\nNote: To use links in the OSM Name field and open the exact area you want to edit, please install [JOSM](https://josm.openstreetmap.de/), an open-source editor for OpenStreetMap.',
        false,
        '{2}',
        true
from osm_meta;
...
\nNote: To open the area you want to edit, please install [JOSM](https://josm.openstreetmap.de/), an open-source editor for OpenStreetMap.',
        false,
        '{1}',
        true
from osm_meta;
