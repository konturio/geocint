...
values ('population', 'Population', jsonb_build_array(
        ...
        'Constrained Individual countries 2020 UN adjusted (100m resolution): WorldPop - https://www.worldpop.org/',
        '© OpenStreetMap contributors https://www.openstreetmap.org/copyright'),
        '[["unimportant"], ["important"]]'::jsonb);
...
insert into bivariate_indicators (param_id, param_label, copyrights, direction)
values ('covid19_cases', 'COVID19 Cases (per 100,000 people, 7-day average)', jsonb_build_array(
'© Data from Delphi COVIDcast, covidcast.cmu.edu'),
    '[["good"], ["bad"]]'::jsonb);
