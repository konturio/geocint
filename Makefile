...
data/uae_routing/uae-bicycle-latest: data/uae_routing/uae-latest.osm.pbf data/uae_routing/uae_boundary.geojson data/uae_routing/uae-latest.osm.pbf
	...
	docker run -t -v "${PWD}/data/uae_routing:/data" osrm/osrm-backend osrm-extract -p /data/bicycle.lua /data/uae-bicycle-latest.osm.pbf
	docker run -t -v "${PWD}/data/uae_routing:/data" osrm/osrm-backend osrm-partition /data/uae-bicycle-latest.osrm
	docker run -t -v "${PWD}/data/uae_routing:/data" osrm/osrm-backend osrm-customize /data/uae-bicycle-latest.osrm
...
data/uae_routing/uae-bike-latest: data/uae_routing/uae-latest.osm.pbf data/uae_routing/uae_boundary.geojson data/uae_routing/uae-latest.osm.pbf
	...
	docker run -t -v "${PWD}/data/uae_routing:/data" osrm/osrm-backend osrm-extract -p /data/bike.lua /data/uae-bike-latest.osm.pbf
	docker run -t -v "${PWD}/data/uae_routing:/data" osrm/osrm-backend osrm-partition /data/uae-bike-latest.osrm
	docker run -t -v "${PWD}/data/uae_routing:/data" osrm/osrm-backend osrm-customize /data/uae-bike-latest.osrm
	rm -f data/uae_routing/uae-bike-latest.osm.pbf
	touch $@

data/uae_routing: data/uae_routing/uae-bicycle-latest data/uae_routing/uae-bike-latest
	touch $@
