...
data/out/csv/avg_forest_canopy_height.csv: db/table/meta_forest_canopy_height_h3 | data/out/csv ## extract avg_forest_canopy_height to csv file 
	psql -q -X -c "copy (select h3, avg_height as avg_forest_canopy_height from meta_forest_canopy_height_h3 where h3 is not null and avg_height is not null) to stdout with delimiter ',' csv;" > data/out/csv/avg_forest_canopy_height.csv
	touch $@
...
data/out/csv/max_forest_canopy_height.csv: db/table/meta_forest_canopy_height_h3 | data/out/csv ## extract max_forest_canopy_height to csv file 
	psql -q -X -c "copy (select h3, max_height as max_forest_canopy_height from meta_forest_canopy_height_h3 where h3 is not null and max_height is not null) to stdout with delimiter ',' csv;" > data/out/csv/max_forest_canopy_height.csv
	touch $@
