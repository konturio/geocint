...
deploy/dev/uploads/forest_upload: data/out/csv/forest.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload forest to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/forest.csv "forest" "Landcover: forest" "[[\"unimportant\"], [\"important\"]]" false true "[\"© Kontur https://kontur.io/\", \"Copernicus Global Land Service: Land Cover 100 m: Marcel Buchhorn, Bruno Smets, Luc Bertels, Bert De Roo, MyroslavaLesiv, Nandin - Erdene Tsendbazar, … Steffen Fritz. (2020). Copernicus Global Land Service: Land Cover 100m: collection 3: epoch 2019: Globe (Version V3.0.1) Data set. Zenodo. http://doi.org/10.5281/zenodo.3939050\"]" "Area covered by forest - where tree canopy is more than 15%." "World" "static" "km2" "$(date -r db/table/copernicus_forest_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/shrubs_upload: data/out/csv/shrubs.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload shrubs to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/shrubs.csv "shrubs" "Landcover: shrubland" "[[\"unimportant\"], [\"important\"]]" false true "[\"© Kontur https://kontur.io/\", \"Copernicus Global Land Service: Land Cover 100 m: Marcel Buchhorn, Bruno Smets, Luc Bertels, Bert De Roo, MyroslavaLesiv, Nandin - Erdene Tsendbazar, … Steffen Fritz. (2020). Copernicus Global Land Service: Land Cover 100m: collection 3: epoch 2019: Globe (Version V3.0.1) Data set. Zenodo. http://doi.org/10.5281/zenodo.3939050\"]" "Shrubland, or area where vegetation is dominated by woody perennial plants generally less than 5 meters in height, with persistent and woody stems and without any defined main stem. The shrub foliage can be either evergreen or deciduous." "World" "static" "km2" "$(date -r db/table/copernicus_forest_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/herbage_upload: data/out/csv/herbage.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload herbage to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/herbage.csv "herbage" "Landcover: herbaceous vegetation" "[[\"unimportant\"], [\"important\"]]" false true "[\"© Kontur https://kontur.io/\", \"Copernicus Global Land Service: Land Cover 100 m: Marcel Buchhorn, Bruno Smets, Luc Bertels, Bert De Roo, MyroslavaLesiv, Nandin - Erdene Tsendbazar, … Steffen Fritz. (2020). Copernicus Global Land Service: Land Cover 100m: collection 3: epoch 2019: Globe (Version V3.0.1) Data set. Zenodo. http://doi.org/10.5281/zenodo.3939050\"]" "Area covered by herbaceous plants. These plants have no persistent woody stems above ground and lack definite firm structure. Tree and shrub cover is less than 10%." "World" "static" "km2" "$(date -r db/table/copernicus_forest_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/total_building_count_upload: data/out/csv/total_building_count.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload total_building_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/total_building_count.csv "total_building_count" "Total buildings count" "[[\"unimportant\"], [\"important\"]]" false true "[\"© Kontur https://kontur.io/\", \"Copernicus Global Land Service: Land Cover 100 m: Marcel Buchhorn, Bruno Smets, Luc Bertels, Bert De Roo, MyroslavaLesiv, Nandin - Erdene Tsendbazar, … Steffen Fritz. (2020). Copernicus Global Land Service: Land Cover 100m: collection 3: epoch 2019: Globe (Version V3.0.1) Data set. Zenodo. http://doi.org/10.5281/zenodo.3939050\", \"Geoalert Urban Mapping: Chechnya, Moscow region, Tyva - https://github.com/Geoalert/urban-mapping\", \"Microsoft Buildings: Australia, Canada, Tanzania, Uganda, USA: This data is licensed by Microsoft under the Open Data Commons Open Database License (ODbL).\", \"NZ Building Outlines data sourced from the LINZ Data Service - https://data.linz.govt.nz/\", \"© OpenStreetMap contributors https://www.openstreetmap.org/copyright\"]" "Estimated number of buildings in a given area based on various data sources." "World" "daily" "n" "$(date -r db/table/building_count_grid_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/foursquare_places_count_upload: data/out/csv/foursquare_places_count.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload foursquare_places_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/foursquare_places_count.csv "foursquare_places_count" "Foursquare Japan places count" "[[\"unimportant\"], [\"important\"]]" false false "[\"©Foursquare Labs Inc\", \"Sample data\"]" "" "Japan" "static" "n" "$(date -r db/table/foursquare_places_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/foursquare_visits_count_upload: data/out/csv/foursquare_visits_count.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload foursquare_visits_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/foursquare_visits_count.csv "foursquare_visits_count" "Foursquare Japan visits count" "[[\"unimportant\"], [\"important\"]]" false false "[\"©Foursquare Labs Inc\", \"Sample data\"]" "" "Japan" "static" "n" "$(date -r db/table/foursquare_visits_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/mhr_index_upload: data/out/csv/mhr_index.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload mhr_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/mhr_index.csv "mhr_index" "PDC GRVA Multi-hazard risk" "[[\"unimportant\"], [\"important\", \"bad\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/mhe_index_upload: data/out/csv/mhe_index.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload mhe_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/mhe_index.csv "mhe_index" "PDC GRVA Multi-hazard exposure" "[[\"unimportant\"], [\"important\", \"bad\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/coping_capacity_index_upload: data/out/csv/coping_capacity_index.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload coping_capacity_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/coping_capacity_index.csv "coping_capacity_index" "PDC GRVA Coping сapacity" "[[\"important\", \"bad\"], [\"good\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/resilience_index_upload: data/out/csv/resilience_index.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload resilience_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/resilience_index.csv "resilience_index" "PDC GRVA Resilience" "[[\"important\", \"bad\"], [\"good\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/dev/uploads/vulnerability_index_upload: data/out/csv/vulnerability_index.csv db/table/insights_api_indicators_list_dev | data/out/csv ## upload vulnerability_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/vulnerability_index.csv "vulnerability_index" "PDC GRVA Vulnerability" "[[\"unimportant\"], [\"important\", \"bad\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/test/uploads/foursquare_places_count_upload: data/out/csv/foursquare_places_count.csv db/table/insights_api_indicators_list_test | data/out/csv ## upload foursquare_places_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/foursquare_places_count.csv "foursquare_places_count" "Foursquare Japan places count" "[[\"unimportant\"], [\"important\"]]" false false "[\"©Foursquare Labs Inc\", \"Sample data\"]" "" "Japan" "static" "n" "$(date -r db/table/foursquare_places_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/test/uploads/foursquare_visits_count_upload: data/out/csv/foursquare_visits_count.csv db/table/insights_api_indicators_list_test | data/out/csv ## upload foursquare_visits_count to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/foursquare_visits_count.csv "foursquare_visits_count" "Foursquare Japan visits count" "[[\"unimportant\"], [\"important\"]]" false false "[\"©Foursquare Labs Inc\", \"Sample data\"]" "" "Japan" "static" "n" "$(date -r db/table/foursquare_visits_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/test/uploads/mhr_index_upload: data/out/csv/mhr_index.csv db/table/insights_api_indicators_list_test | data/out/csv ## upload mhr_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/mhr_index.csv "mhr_index" "PDC GRVA Multi-hazard risk" "[[\"unimportant\"], [\"important\", \"bad\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/test/uploads/mhe_index_upload: data/out/csv/mhe_index.csv db/table/insights_api_indicators_list_test | data/out/csv ## upload mhe_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/mhe_index.csv "mhe_index" "PDC GRVA Multi-hazard exposure" "[[\"unimportant\"], [\"important\", \"bad\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/test/uploads/coping_capacity_index_upload: data/out/csv/coping_capacity_index.csv db/table/insights_api_indicators_list_test | data/out/csv ## upload coping_capacity_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/coping_capacity_index.csv "coping_capacity_index" "PDC GRVA Coping сapacity" "[[\"important\", \"bad\"], [\"good\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/test/uploads/resilience_index_upload: data/out/csv/resilience_index.csv db/table/insights_api_indicators_list_test | data/out/csv ## upload resilience_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/resilience_index.csv "resilience_index" "PDC GRVA Resilience" "[[\"important\", \"bad\"], [\"good\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy/test/uploads/vulnerability_index_upload: data/out/csv/vulnerability_index.csv db/table/insights_api_indicators_list_test | data/out/csv ## upload vulnerability_index to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/vulnerability_index.csv "vulnerability_index" "PDC GRVA Vulnerability" "[[\"unimportant\"], [\"important\", \"bad\"]]" false false "[\"© 2022 Pacific Disaster Center. https://www.pdc.org/privacy-policy/\"]" "" "World" "static" "index" "$(date -r db/table/global_rva_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
