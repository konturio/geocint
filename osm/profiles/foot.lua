...
function setup()
  ...
  return {
    ...
    speeds = Sequence {
      highway = {
  --      primary         = walking_speed*0.5,
    --    primary_link    = walking_speed*0.5,
   --     secondary       = walking_speed*0.5,
    --    secondary_link  = walking_speed*0.5,
    --    tertiary        = walking_speed*0.6,
    --    tertiary_link   = walking_speed*0.6,
        unclassified    = walking_speed*0.9,
        residential     = walking_speed*0.9,
        road            = walking_speed*0.9,
        living_street   = walking_speed*0.9,
        service         = walking_speed*0.9,
