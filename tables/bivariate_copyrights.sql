...
insert into bivariate_copyrights (param_id, copyrights)
values ('count', jsonb_build_array('Map Object Density',
...
insert into bivariate_copyrights (param_id, copyrights)
values ('top_user', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, copyrights)
values ('osm_users', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, copyrights)
values ('amenity_count', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));
...
insert into bivariate_copyrights (param_id, copyrights)
values ('osm_users_recent', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, copyrights)
values ('top_user_objects', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));
