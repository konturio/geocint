...
insert into bivariate_indicators (param_id, param_label, copyrights, direction, description, coverage, update_frequency, unit_id, is_public, emoji)
values ('uprooted_people', 'Uprooted People', jsonb_build_array('© INFORM Initiative https://www.inform-index.org/'), '[["good"], ["bad"]]'::jsonb, 'The Uprooted people component is the arithmetic average of the absolute and relative value of uprooted people. The absolute value is
presented using the log transformation while the uprooted people relative to the total population are transformed into indicator using the GNA criteria and then normalised into range from 0 to 10.', 'World', 'annual', 'index', TRUE, '🏠');
...
insert into bivariate_indicators (param_id, param_label, copyrights, direction, description, coverage, update_frequency, unit_id, is_public, emoji)
values ('governance', 'Governance', jsonb_build_array('© INFORM Initiative https://www.inform-index.org/'), '[["bad"], ["good"]]'::jsonb, 'Level of governance stability affecting overall risk levels on a scale of 0 to 10.', 'World', 'annual', 'index', TRUE, '📜');

insert into bivariate_indicators (param_id, param_label, copyrights, direction, description, coverage, update_frequency, unit_id, is_public, emoji)
values ('infrastructure', 'Infrastructure', jsonb_build_array('© INFORM Initiative https://www.inform-index.org/'), '[["bad"], ["good"]]'::jsonb, 'Condition and resilience of essential infrastructure in a region on a scale of 0 to 10.', 'World', 'annual', 'index', TRUE, '🏗️');
...
insert into bivariate_indicators (param_id, param_label, copyrights, direction, description, coverage, update_frequency, unit_id, is_public, emoji)
values ('physical_infrastructure', 'Physical Infrastructure', jsonb_build_array('© INFORM Initiative https://www.inform-index.org/'), '[["bad"], ["good"]]'::jsonb, 'State of physical assets and facilities impacting disaster response on a scale of 0 to 10.', 'World', 'annual', 'index', TRUE, '🏢');
