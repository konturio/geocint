...
reports/osm_population_validation.html: db/table/osm_population_validation | reports
	psql -HX -c 'select * from osm_population_validation;' > $@
	touch $@
