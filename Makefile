...
db/table/osm_hotels_h3: db/table/osm_hotels | db/procedure/generate_overviews db/table ## Calculate number of hotel and assesment per hexagon
	...
	psql -c "call generate_overviews('osm_hotels_h3', '{osm_hotels_count,max_osm_hotels_assesment,avg_osm_hotels_assesment}'::text[], '{sum,max,avg}'::text[], 8);"
	touch $@
