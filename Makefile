all: deploy/geocint/isochrone_tables deploy/_all data/population/population_api_tables.sqld.gz data/kontur_population.gpkg.gz db/table/covid19 db/table/population_grid_h3_r8_osm_scaled data/morocco_buildings/morocco_buildings_benchmark_roofprints_phase2.geojson.gz data/morocco_buildings/morocco_buildings_benchmark_phase2.geojson.gz db/table/morocco_buildings_iou db/table/morocco_buildings_iou_new_dataset
...
db/table/morocco_buildings: data/morocco_buildings/geoalert_morocco_stage_2.gpkg | db/table
	...
	ogr2ogr -f GeoJSON data/morocco_buildings/morocco_buildings_footprints_phase2.geojson PG:'dbname=gis' -sql 'select ST_Transform(geom, 4326) as footprint, height as building_height, height_confidence, is_residential, imagery_vintage from morocco_building_date' -nln morocco_buildings_footprints_phase2
...
db/table/morocco_buildings_benchmark: data/morocco_buildings_geoalert_footprints/agadir_footprints.geojson data/morocco_buildings_geoalert_footprints/casablanca_footprints.geojson data/morocco_buildings_geoalert_footprints/casablanca_footprints.geojson data/morocco_buildings_geoalert_footprints/fes_footprints.geojson data/morocco_buildings_geoalert_footprints/meknes_footprints.geojson | db/table
