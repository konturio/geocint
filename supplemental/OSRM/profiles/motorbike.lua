...
function setup()
  return {
    properties = {
      max_speed_for_map_matching      = 50/3.6, -- 50kmph -> m/s
    ...
    maxspeed_table = {
      ...
      ["dk:rural"] = 50,
      ["fr:rural"] = 50,
      ["gb:nsl_single"] = (30*1609)/1000,
      ["gb:nsl_dual"] = (30*1609)/1000,
      ["gb:motorway"] = (30*1609)/1000,
      ["nl:rural"] = 50,
      ["nl:trunk"] = 50,
      ['no:rural'] = 50,
      ['no:motorway'] = 50,
      ...
      ["ru:urban"] = 50,
      ["ru:motorway"] = 50,
      ["uk:nsl_single"] = (30*1609)/1000,
      ["uk:nsl_dual"] = (30*1609)/1000,
      ["uk:motorway"] = (30*1609)/1000,
      ['za:urban'] = 50,
      ['za:rural'] = 50,
      ["none"] = 50
    },
