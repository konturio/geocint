...
db/function/h3_resolution: | db/function/h3
	psql -f functions/h3_resolution.sql
	touch $@
...
data/tiles/users_tiles.tar.bz2: db/table/osm_user_count_grid_h3 db/table/osm_meta db/function/h3_resolution | data/tiles
