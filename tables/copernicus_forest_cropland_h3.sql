drop table if exists copernicus_forest_cropland_h3_in;
create table copernicus_forest_cropland_h3_in as (
    select h3,
           8                                                               as resolution,
...
$$
    ...
    begin
        ...
        while res > 0
            loop
                insert into copernicus_forest_cropland_h3_in (h3, forest_area, evergreen_needle_leaved_forest, shrubs, herbage,
                                                     unknown_forest, cropland, area_km2, resolution)
                select h3_cell_to_parent(h3),
                       ...
                       (res - 1)
                from copernicus_forest_cropland_h3_in
...
drop table if exists copernicus_forest_cropland_h3;
create table copernicus_forest_cropland_h3
(
    like copernicus_forest_cropland_h3_in
);
