...
db/table/firms_fires: data/firms/unzip | db/table
	...
	cat data/firms/fire_nrt_J1V-C2_162052.csv | tail -n +1 | psql -c "set time zone utc; copy firms_fires (latitude, longitude, brightness, scan, track, acq_date, acq_time, satellite, instrument, confidence, version, bright_t31, frp, daynight);"
	cat data/firms/fire_nrt_M6_162051.csv | tail -n +1 | psql -c "set time zone utc; copy firms_fires (latitude, longitude, brightness, scan, track, acq_date, acq_time, satellite, instrument, confidence, version, bright_t31, frp, daynight);"
	cat data/firms/fire_nrt_V1_162053.csv | tail -n +1 | psql -c "set time zone utc; copy firms_fires (latitude, longitude, brightness, scan, track, acq_date, acq_time, satellite, instrument, confidence, version, bright_t31, frp, daynight);"
	touch $@
