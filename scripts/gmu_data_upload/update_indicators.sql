...
insert into bivariate_indicators (
    ...
    update_frequency, spatial_resolution, temporal_extent,
    unit_id, is_public, emoji, downscale
) values
...
('gmu_air_temperature', 'GMU Air Temperature Dataset',
 ...
 'United States', 'every_20min', 'feature_derived', 'current_value', 'fahrenheit', TRUE, '🌡️', 'equal'),
...
('gmu_rain_accumulation', 'GMU Rain Accumulation Dataset',
 ...
 'United States', 'every_20min', 'feature_derived', 'current_value', 'inches', TRUE, '🌧️', 'equal'),
...
('gmu_relative_humidity', 'GMU Relative Humidity Dataset',
 ...
 'United States', 'every_20min', 'feature_derived', 'current_value', 'percentage', TRUE, '💧', 'equal'),
...
('gmu_solar_radiation', 'GMU Solar Radiation Dataset',
 ...
 'United States', 'every_20min', 'feature_derived', 'current_value', 'watts per square meter', TRUE, '☀️', 'equal'),
...
('gmu_wind_direction', 'GMU Wind Direction Dataset',
 ...
 'United States', 'every_20min', 'feature_derived', 'current_value', 'degrees', TRUE, '🧭', 'equal'),
...
('gmu_wind_speed', 'GMU Wind Speed Dataset',
 ...
 'United States', 'every_20min', 'feature_derived', 'current_value', 'mph', TRUE, '💨', 'equal'),
