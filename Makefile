...
data/out/csv/total_stock_displacement.csv: db/table/idmc_country_2023_h3 | data/out/csv ## extract total_stock_displacement to csv file
	psql -q -X -c "copy (select h3, total_stock_displacement from idmc_country_2023_h3 where h3 is not null and total_stock_displacement is not null and total_stock_displacement > 0 order by h3) to stdout with delimiter ',' csv;" > $@
...
deploy_indicators/dev/uploads/total_stock_displacement_upload: data/out/csv/total_stock_displacement.csv | deploy_indicators/dev/uploads ## upload total_stock_displacement to insight-api
	bash scripts/upload_csv_to_insights_api.sh dev data/out/csv/total_stock_displacement.csv "total_stock_displacement" "[[\"good\", \"unimportant\"], [\"bad\", \"important\"]]" false true "[\"© Kontur Boundaries https://data.humdata.org/dataset/kontur-boundaries\", \"© 2012-2024 Internal Displacement Monitoring Centre (IDMC)\"]" "Percent of total population of IDPs (rounded figures at the national level), as a result of conflicts, violence and disasters as of the end of the reporting year." "World" "static" "perc" "$(date -r db/table/idmc_country_2023_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy_indicators/test/uploads/total_stock_displacement_upload: data/out/csv/total_stock_displacement.csv | deploy_indicators/test/uploads ## upload total_stock_displacement to insight-api
	bash scripts/upload_csv_to_insights_api.sh test data/out/csv/total_stock_displacement.csv "total_stock_displacement" "[[\"good\", \"unimportant\"], [\"bad\", \"important\"]]" false true "[\"© Kontur Boundaries https://data.humdata.org/dataset/kontur-boundaries\", \"© 2012-2024 Internal Displacement Monitoring Centre (IDMC)\"]" "Percent of total population of IDPs (rounded figures at the national level), as a result of conflicts, violence and disasters as of the end of the reporting year." "World" "static" "perc" "$(date -r db/table/idmc_country_2023_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
...
deploy_indicators/prod/uploads/total_stock_displacement_upload: data/out/csv/total_stock_displacement.csv | deploy_indicators/prod/uploads ## upload total_stock_displacement to insight-api
	bash scripts/upload_csv_to_insights_api.sh prod data/out/csv/total_stock_displacement.csv "total_stock_displacement" "[[\"good\", \"unimportant\"], [\"bad\", \"important\"]]" false true "[\"© Kontur Boundaries https://data.humdata.org/dataset/kontur-boundaries\", \"© 2012-2024 Internal Displacement Monitoring Centre (IDMC)\"]" "Percent of total population of IDPs (rounded figures at the national level), as a result of conflicts, violence and disasters as of the end of the reporting year." "World" "static" "perc" "$(date -r db/table/idmc_country_2023_h3 +'%Y-%m-%dT%H:%M:%SZ')"
	touch $@
