...
create index on topology_boundary_mid1 using btree(osm_id, admin_level, maritime);
...
create table topology_boundary as
    select t.osm_id,
           ...
           k.default_language,
           t.geom
    from topology_boundary_mid2 t left join kontur_boundaries k 
