...
insert into bivariate_copyrights (param_id, copyrights)
values ('local_hours', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, copyrights)
values ('total_hours', jsonb_build_array('© OpenStreetMap contributors https://www.openstreetmap.org/copyright'));

insert into bivariate_copyrights (param_id, copyrights)
values ('gdp', jsonb_build_array('© 2019 The World Bank Group, CC-BY 4.0',
