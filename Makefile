...
deploy/_all: deploy/geocint/osm_quality_bivariate_tiles deploy/lima/osm_quality_bivariate_tiles deploy/dollar/osm_quality_bivariate_tiles deploy/geocint/stats_tiles deploy/geocint/users_tiles
	touch $@
